...
class AdvertCreate(LoginRequiredMixin, CreateView, PermissionRequiredMixin):
    permission_required = ('board.add_advert',)
...
class AdvertUpdate(LoginRequiredMixin, UpdateView, PermissionRequiredMixin):
